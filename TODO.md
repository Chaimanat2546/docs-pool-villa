...
| M06 Media Lifecycle | Complete — Staging lifecycle and retry/UI-refresh regression verified; test fixtures retained pending cleanup approval | [TODO](docs/todo/M06-media-management.md) |
